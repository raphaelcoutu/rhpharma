<template>
    <tbody>
        <tr v-for="user in dataUsers">
            ...
            <CalendarCell v-for="(date, index) in dataDates"
            ...
            >
                <template #assignedShifts v-if="getAssignedShiftByDay(user.id, date)">
                    <div v-html="getAssignedShiftByDay(user.id, date)"></div>
                </template>
