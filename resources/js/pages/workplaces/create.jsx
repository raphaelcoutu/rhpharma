...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Nouveau lieu de travail" />
            ...
            <div className="py-10 sm:py-12">
                <div className="mx-auto max-w-4xl space-y-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold tracking-tight text-gray-900">Créer un lieu de travail</h1>
                            <p className="mt-1 text-sm text-gray-500">Ajoutez les coordonnées du lieu pour pouvoir y rattacher des secteurs.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-start">
                        <SecondaryButton as={Link} href={route('workplaces.index')}>
                            Annuler
                        </SecondaryButton>
                    </div>
                </div>
