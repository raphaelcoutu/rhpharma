        ...
        <form className="w-full" onSubmit={onSubmit}>
            <div className="flex flex-col gap-2">
                <div className="flex">
                    ...
                    <div className="w-3/4">
                        <Input className="w-full" type="text" name="name" value={data.name} onChange={(e) => setData('name', e.target.value)} />
                ...
                <div className="flex">
                    ...
                    <div className="w-3/4">
                        <Select
                            ...
                            onValueChange={(value) => setData('department_type_id', value)}
                        >
                            <SelectTrigger>
                ...
                <div className="flex">
                    ...
                    <div className="w-3/4">
                        <Select
                            ...
                            onValueChange={(value) => setData('workplace_id', value)}
                        >
                            <SelectTrigger>
                                <SelectValue placeholder="-- Choisir --" />
                            </SelectTrigger>
