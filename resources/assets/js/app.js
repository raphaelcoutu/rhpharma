...
Vue.component('rhpharma-schedule-output', require('./components/Schedule-Output.vue'));
Vue.component('rhpharma-schedule-processus', require('./components/Schedule-Processus.vue'));
